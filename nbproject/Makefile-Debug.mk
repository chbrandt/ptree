...
.build-conf: ${BUILD_SUBPROJECTS}
	${MAKE}  -f nbproject/Makefile-Debug.mk dist/Debug/GNU-MacOSX/ptree

dist/Debug/GNU-MacOSX/ptree: ${OBJECTFILES}
...
${OBJECTDIR}/ptree_bit.o: nbproject/Makefile-${CND_CONF}.mk ptree_bit.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ptree_bit.o ptree_bit.c
...
${OBJECTDIR}/ptree_getoccurrences.o: nbproject/Makefile-${CND_CONF}.mk ptree_getoccurrences.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ptree_getoccurrences.o ptree_getoccurrences.c

${OBJECTDIR}/ptree_destroy.o: nbproject/Makefile-${CND_CONF}.mk ptree_destroy.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ptree_destroy.o ptree_destroy.c

${OBJECTDIR}/search_text4key.o: nbproject/Makefile-${CND_CONF}.mk search_text4key.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/search_text4key.o search_text4key.c

${OBJECTDIR}/ptree_print.o: nbproject/Makefile-${CND_CONF}.mk ptree_print.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ptree_print.o ptree_print.c

${OBJECTDIR}/ptree_library.o: nbproject/Makefile-${CND_CONF}.mk ptree_library.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ptree_library.o ptree_library.c

${OBJECTDIR}/ptree_create.o: nbproject/Makefile-${CND_CONF}.mk ptree_create.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.c) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/ptree_create.o ptree_create.c
...
.clean-conf:
	${RM} -r build/Debug
	${RM} dist/Debug/GNU-MacOSX/ptree
